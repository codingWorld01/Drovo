...
const Setup = () => {
  ...
  const requestNotificationPermission = async () => {
    try {
      ...
      if (permission === 'granted') {
        ...
        setFormData((prevData) => ({ ...prevData, browserNotificationOptIn: false, fcmToken: '' }));
        return false;
      }
    } catch (error) {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (!formData.address || !formData.city || !formData.state || !formData.postal_code) {
      toast.error('Please complete all address fields.');
      return;
    }

    if (!formData.latitude || !formData.longitude) {
      toast.error('Please provide location coordinates by entering a valid address.');
      return;
    }
      ...
      <form onSubmit={onSubmitHandler} className="setup-form">
        ...
        <div className="file-input-container">
          ...
          <input
            ...
            required
          />
          {shopImage && <p className="file-name">{shopImage.name} Selected</p>}
        </div>
            ...
            <div className="modal-content">
              ...
              <ul>
                ...
                <ul>
                  ...
                  <li>For COD orders, shopkeepers must remit the 1% platform commission to Drovo at the end of the month.</li>
                </ul>
